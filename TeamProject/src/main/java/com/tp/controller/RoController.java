...
public class RoController {
	...
	public String roReview(Model model,
		...
		if(keyword == null) {
			list = boardservice.GenreAndCategory("로맨스", "리뷰", pageable);
		}else {
			list = boardservice.genreAndSearch("로맨스", keyword, pageable);
		}
	...
	public String roRecom(Model model,
		...
		if(keyword == null) {
			list = boardservice.GenreAndCategory("로맨스", "추천", pageable);
		}else {
			list = boardservice.genreAndSearch("로맨스", keyword, pageable);
		}
	...
	public String roInfo(Model model,
		...
		if(keyword == null) {
			list = boardservice.GenreAndCategory("로맨스", "정보", pageable);
		}else {
			list = boardservice.genreAndSearch("로맨스", keyword, pageable);
		}
