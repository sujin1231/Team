      ...
      <form name="regform" action="register.board" method="post">
         ...
         <tr>
            <td colspan="2" align="center">
               <input type="button" value="목록" onclick="location.href='review?page=${param.page}'">
               <input type="button" value="수정" onclick="location.href='review_modify?num=${one.num }&page=${param.page}'">
            </td>
         </tr>
         </table>
      </form>
