...
<body>
   <section>
      ...
      <form name="regform" action="recom_register.recom" method="post">
         <h2>게시판 글내용 보기</h2>
         ...
         <tr>
            <td colspan="2" align="center">
               <input type="button" value="목록" onclick="location.href='recom?page=${recom.page}'">
               <input type="button" value="수정" onclick="location.href='recom_modify?num=${one.num}'">
            </td>
         </tr>
         </table>
      </form>
