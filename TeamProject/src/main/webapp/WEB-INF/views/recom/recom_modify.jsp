...
<body>
	<header>
	    ...
	    <h2><center>글 작성</center></h2>
	        <form class="regform" action="recom_modify" method = "post" enctype="multipart/form-data">
	        	<tr>
		            ...
		            <hr>
		            장르 : <input type="button" name = "genre" id = "genre" value = "${one.genre }">
		            <select id="genre" name="genre">
		            	<option value="${one.genre }">=선택=</option>
		            ...
		            <div class="button">
		                ...
		                <p>
			               ...
			               <input type="button" value="목록" onclick="location.href='recom?page=${param.page}'">
